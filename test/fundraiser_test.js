...
contract("Fundraiser", accounts => {
    ...
    describe("making donations", () => {
        ...
        it("increases myDonationsCount", async () => {
            ...
            assert.equal(1, newDonationsCount - currentDonationsCount, ",myDonationsCount should increase by 1");
        });
        ...
        describe("access controls", () => {
            it("throws an error when called from a non-owner account", async () => {
                try {
                    ...
                    assert.fail("withdrawal was not restricted to owners")
                } catch(err) {
                    const expectedError = "Ownable: caller is not the owner"
                    const actualError = err.reason;
                    assert.equal(actualError, expectedError, "should not be permitted");
        ...
        describe("withdraw balance", () => {
            it("transfers the balance to the beneficiary", async () => {
                ...
                assert.equal(
                    ...
                    "beneficiary should receive all funds"
                );
            });
    ...
    describe("receive and fallback functions", () => {
        describe("receive function", () => {
            ...
            it("increases donations count", async () => {
                ...
                assert.equal(
                    1,
                    newDonationsCount - currentDonationsCount,
                    "donations should increment by 1"
                );
            });
        });
    });
